package com.imkola.client.view;
...
public class CustomProgressBar extends View {
    ...
    public CustomProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.getTheme().obtainStyledAttributes(attrs, R.styleable.imageProgressBar,
                defStyleAttr, 0);
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.imageProgressBar_firstColor:
                    firstColor = ta.getColor(attr, Color.LTGRAY); // 默认底色为亮灰色
                    break;
                case R.styleable.imageProgressBar_secondColor:
                    secondColor = ta.getColor(attr, Color.BLUE); // 默认进度条颜色为蓝色
                    break;
                case R.styleable.imageProgressBar_circleWidth:
